export const Logo = () => {
  return (
    <div className="w-7 ">
      ...
      >
        <g clip-path="url(#clip0_3657_79)">
          <ellipse cx="10.4" cy="11" rx="10.4" ry="10.4959" fill="#FFA500" />
          <ellipse
            opacity="0.6"
            cx="7.06439"
            cy="6.10078"
            ...
            fill="url(#paint0_radial_3657_79)"
          />
          <path
